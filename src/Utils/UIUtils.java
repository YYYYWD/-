...
public class UIUtils {
    public static final Font FONT_GENERAL_UI = new Font("Microsoft YaHei", Font.PLAIN, 20);
    public static final Font FONT_FORGOT_PASSWORD = new Font("Microsoft YaHei", Font.PLAIN, 12);
    ...
    public static final Color COLOR_MY_BLUE=new Color(37,255,138);
    public static final Color COLOR_MY_RED=new Color(144,255,235);
    ...
    public static final String BUTTON_FIND=" 查找";
    public static final String PLACEHOLDER_TEXT_USERNAME = "Username/email";
    public static final String PLACEHOLDER_FIND_USERNAME = "请输入姓名";
    public static final String PLACEHOLDER_FIND_USERID = "请输入身份证";
    public static final String PLACEHOLDER_FIND_USERTELE = "请输入电话";
